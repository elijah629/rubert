...
export default function ColorPicker(props: { value: FaceletColor | null, onChange: (value: FaceletColor) => void }) {
    return <Card class="grid grid-cols-3 grid-rows-2 gap-1 p-4">
