...
export default function Home() {
	return (
		<div class="flex flex-col items-center justify-center">
			...
			<div class="flex flex-col gap-2 sm:flex-row">
				<A href="/scan" class="flex-1">
					<Card class="flex flex-col transition-colors hover:border-primary">
						<div class="p-2">
						<svg xmlns="http://www.w3.org/2000/svg" class="m-auto h-24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
   ...
   <path d="M9 13a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"></path>
						...
						<h3 class="text-2xl mb-1 font-black">Scan</h3>
						<p class="text-sm text-muted-foreground">Use your camera to scan your cube</p>
						</div>
					</Card>
				</A>
				<A href="/manual" class="flex-1">
					<Card class="flex flex-col transition-colors hover:border-primary">
						<div class="p-2">
						<svg xmlns="http://www.w3.org/2000/svg" class="m-auto h-24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
   <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
